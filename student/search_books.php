                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form name="form1" action="" method="post">
                                    <table class="table">
                                        <tr>
                                            <td><input type="text" name="ti" placeholder="Enter books name" required="" class="form-control"></td>
                                ...
                                $res=mysqli_query($link,"select * from add_books where books_name like('%$_POST[ti]%')");
